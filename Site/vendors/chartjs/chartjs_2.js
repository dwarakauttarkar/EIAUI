        ...
        initialize: function(data) {
            ...
            this.ScaleClass = Chart.Scale.extend({
                ...
                calculateBaseWidth: function() {
                    ...
                    var calculated = (this.calculateX(1) - this.calculateX(0)) - (2 * options.barValueSpacing);

                    if(options.barMaxWidth &&  calculated > options.barMaxWidth){
                        return options.barMaxWidth;
                    }
