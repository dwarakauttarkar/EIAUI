...
(function() {
  ...
  paginationTemplate = "<div style='margin: 0px;' class='angularTablePaginationBlock'> <ul class='angularTablePagination'> <li ng-class='{disabled: getCurrentPage() <=0}'> <a href='' ng-click='stepPage(-numberOfPages)'>First</a> </li><li ng-show='showSectioning()' ng-class='{disabled: getCurrentPage() <=0}'> <a href='' ng-click='jumpBack()'>&laquo;</a> </li><li ng-class='{disabled: getCurrentPage() <=0}'> <a href='' ng-click='stepPage(-1)'>&lsaquo;</a> </li><li ng-if='getCurrentPage() - 2 > 0'> <a>...</a> </li><li ng-class='{active: getCurrentPage()==page}' ng-repeat='page in pageSequence.data | filter:paginationFilterLogic' > <a href='' ng-click='goToPage(page)' ng-bind='page + 1'></a> </li><li ng-if='getCurrentPage() + 2 < numberOfPages - 1'> <a>...</a> </li><li ng-class='{disabled: getCurrentPage() >=numberOfPages - 1}'> <a href='' ng-click='stepPage(1)'>&rsaquo;</a> </li><li ng-show='showSectioning()' ng-class='{disabled: getCurrentPage() >=numberOfPages - 1}'> <a href='' ng-click='jumpAhead()'>&raquo;</a> </li><li ng-class='{disabled: getCurrentPage() >=numberOfPages - 1}'> <a href='' ng-click='stepPage(numberOfPages)'>Last</a> </li></ul></div>";
    ...
    function() {
      return {
        ...
        link: function($scope, $element, $attributes) {
          ...
          $scope.paginationFilterLogic = function(page){
              if((page >= $scope.getCurrentPage() - 2) && (page <= $scope.getCurrentPage() + 2))
                return true;
              else if(page < 5 && $scope.getCurrentPage() < 3)
                return true;
              else if(page > $scope.numberOfPages - 6 && $scope.getCurrentPage() > $scope.numberOfPages - 3)
                return true;
              else
                return false;
          };
