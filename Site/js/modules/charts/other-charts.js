    ...
    .directive('sparklineBar', function(){
        ...
        return {
            ...
            link: function(scope, element) {
                function sparkLineBar(selector, values, height, barWidth, barColor, barSpacing,width) {
                ...
                sparkLineBar('.stats-bar-3', [4,7,6,2,5,3,8,6,6,4,8,6,5,8,2,4,6], '45px', 4, '#fff', 3,'150px');
                sparkLineBar('.stats-bar-4', [4,7,6,2,5,0,0,0,0], '45px', 8, '#3F51B5', 5,'150px');
                 sparkLineBar('.stats-bar-5', [47,67,87,65,46,78,0,0,0], '45px', 8, '#8BC34A', 5,'150px');
            }
        }
    })
    ...
    .directive('easypieChart', function(){
        return {
            ...
            link: function(scope, element) {
                ...
                easyPieChart('.percent-chart .chart-block', '#eee', '#ccc', '#009688', 5, 'butt', 95);

                easyPieChart('.percent-chart .chart-block-red', '#eee', '#ccc', '#F44336', 5, 'butt', 95);
                easyPieChart('.percent-chart .chart-block-green', '#eee', '#ccc', '#8BC34A', 5, 'butt', 95);
                easyPieChart('.percent-chart .chart-block-amber', '#eee', '#ccc', '#FFC107', 5, 'butt', 95);

                easyPieChart('.percent-chart .years_block_chart', '#eee', '#ccc', '#FFC107', 5, 'butt', 80);

                easyPieChart('.b1 .easy-pie', '#eee', '#ccc', '#3F51B5', 5, 'butt', 80);
                easyPieChart('.b2 .easy-pie', '#eee', '#ccc', '#8BC34A', 5, 'butt', 80);
            }
        }
    })